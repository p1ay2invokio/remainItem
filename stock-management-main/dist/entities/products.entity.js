...
__decorate([
    (0, typeorm_1.PrimaryColumn)({ name: 'Barcode' }),
    __metadata("design:type", String)
], ProductsEntity.prototype, "Barcode", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'Name' }),
    __metadata("design:type", String)
], ProductsEntity.prototype, "name", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'Qty' }),
    __metadata("design:type", Number)
], ProductsEntity.prototype, "Qty", void 0);
exports.ProductsEntity = ProductsEntity = __decorate([
    (0, typeorm_1.Entity)({ name: 'onepointofsale.product' })
], ProductsEntity);
